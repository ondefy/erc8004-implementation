 ...
 * @notice Non-upgradeable test double for IdentityRegistry behavior.
 * @dev Matches the externally-used interface of IdentityRegistryUpgradeable,
 *      but uses constructor initialization (no proxy / initializer semantics).
 */
contract IdentityRegistryTest is
    ERC721URIStorage,
    Ownable,
    EIP712
{
    ...
    function getVersion() external pure returns (string memory) {
        return "test-non-upgradeable-1.1.0";
    }
}
